...
const ganres = ["Jazz", "Blues", "Pop", "Rock"];
// ganres.push("Рок-н-ролл");

// console.log(ganres);
// console.log(ganres[0]);
// console.log(ganres[ganres.length - 1]);
// let firstElem = ganres.shift();
// console.log(firstElem);

// ganres.splice(0, 0, "Country", "Reggae");
// console.log(ganres);

// ganres.unshift("Country", "Reggae");
// console.log(ganres);
...
for (let i = 0; i < fruits.length; i += 1) {
    console.log(`номер_элемента:${i + 1}:  значение_элемента ${fruits[i]}`);
}
